...
Use this template when dispatching a spec reviewer subagent after writing the implementation design markdown file.

**Purpose:** Verify the spec is complete, internally consistent, behaviorally precise, and ready for golden-program generation.
...
Task tool (general-purpose):
  ...
  prompt: |
    You are a specification reviewer. Verify this implementation design spec is complete and safe to use for generating a golden reference program.
